...
class GUI(QMainWindow):
    ...
    def login(self):
        if client.check_login_data(self.FnameLineLogin.text(), self.LnameLineLogin.text(), self.PassLineLogin.text(), self.PinLogin.text()):
            ...
            PopUpMsg("Login Failed", "Login Failed", "Wrong username or password.", QMessageBox.Warning)
    ...
    def register(self):
        ...
        if(self.FnameLine.text() == "" 
           ...
           or self.AgeBox.text() == ""):
            PopUpMsg("Register Failed", "Register Failed", "Please fill all the fields.", QMessageBox.Warning)

        elif (self.PassLine.text() != self.RPassLine.text()):
            PopUpMsg("Register Failed", "Register Failed", "Passwords do not match.", QMessageBox.Warning)
        else:
            ...
            PopUpMsg("Register Success", "Register Success", "You have successfully registered.", QMessageBox.Information)
    ...
    def Exit(self):
        #are you sure?\
        PopUpMsg("Exit", "Exit", "Are you sure you want to exit?", QMessageBox.Question) 
